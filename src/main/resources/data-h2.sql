...
INSERT INTO COMPETITIONS
  (COMP_ID, BET_AMOUNT, COMPETITION_TYPE, END_DATE, MESSAGE, START_DATE, GROUP_ID, COMPETITION_STATUS, WINNER_ID)
VALUES
  (1, 100, 'Sleep', CURRENT_DATE(), 'What is up?', CURRENT_DATE(), 1, 0, 'auth0|3018490382'),
  (2, 30, 'Sleep', CURRENT_DATE(), 'This competition is very long...', CURRENT_DATE(), 1, 1, 'auth0|3018490382'),
  (3, 5, 'Sleep', CURRENT_DATE(), 'Group 2 competition', CURRENT_DATE(), 2, 2, 'auth0|3018490382'),
